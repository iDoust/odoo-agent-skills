...
║  Examples target supported Odoo versions; verify the target source           ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
5. **Apply only version-specific patterns verified in the target source**
