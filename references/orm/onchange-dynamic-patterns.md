...
<form>
    <group>
        ...
        <field name="line_ids">
            <!-- in v18+ use <list>; in v17 use <tree> -->
...
def _onchange_type(self):
    ...
    Note: In Odoo 18+, storable products have is_storable=True (type is 'consu').
    In Odoo 17, storable products use detailed_type='product'.
    """
    # Version-safe product domains
    storable_domain = [('is_storable', '=', True)] if hasattr(self.env['product.product'], 'is_storable') else [('detailed_type', '=', 'product')]
    domains = {
        'product': storable_domain,
