...
<odoo>
    <record id="action_my_model" model="ir.actions.act_window">
        ...
        <!-- In v18+ use list,form,kanban; in v17 use tree,form,kanban -->
...
<record id="action_my_model_custom" model="ir.actions.act_window">
    ...
    <field name="view_ids" eval="[
        Command.clear(),
        Command.create({'view_mode': 'list', 'view_id': ref('my_model_view_list_custom')}),
        Command.create({'view_mode': 'form', 'view_id': ref('my_model_view_form_custom')}),
    ]"/>
</record>
```
