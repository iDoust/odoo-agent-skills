...
from config import LOG_LEVEL, ODOO_PATH, SQLITE_DB_PATH
from database import Database as IndexDatabase
...
class Database(IndexDatabase):
    """SQLite query database using the indexer's shared schema and connection."""
